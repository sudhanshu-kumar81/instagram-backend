...
export const followOrUnfollow = async (req, res) => {
    ...
    try {
        ...
        if (isFollowing) {
            ...
            return res.status(200).json({ message: 'Unfollowed successfully', success: true ,followKrneWala,jiskoFollowKrunga});
        } else {
            // follow logic ayega
            await Promise.all([
            ...
            return res.status(200).json({ message: 'followed successfully', success: true,followKrneWala,jiskoFollowKrunga });
        }
    } catch (error) {
        console.log(error);
    }
